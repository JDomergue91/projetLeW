            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
                ...
                <div class="card-body"><form role="form" class="text-start">
                    ...
                    <div class="form-check form-switch d-flex align-items-center mb-3">
                        <input class="form-check-input" type="checkbox" id="rememberMe" checked=""><label class="form-check-label mb-0 ms-3" for="rememberMe">Se souvenir de moi</label>
                    </div>
...
<main class="form-signin w-50 m-auto">
  <form method="post" action="/login-action">
    ...
    Mot de passe oublié ? 
    <a href="http://http://projet.lew"> Cliquez içi</a>
